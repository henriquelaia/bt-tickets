...
import { LayoutDashboard, Ticket, LogOut, PlusCircle, Users, Settings, Menu, User as UserIcon } from 'lucide-react';
    ...
    return (
        <div className="flex h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
            ...
            <aside className={clsx(
                "fixed md:static inset-y-0 left-0 z-20 w-64 bg-white shadow-md flex flex-col transition-transform duration-300 ease-in-out transform",
